<div class="space-y-4">
    @foreach ($this->items as $item)
        <div class="flex items-center space-x-4 border p-3 rounded-lg shadow-sm bg-white">
            <img src="{{ $item["img"] ?? "https://static.vecteezy.com/system/resources/previews/028/047/017/non_2x/3d-check-product-free-png.png" }}" alt="{{ $item["name"] }}" class="w-16 h-16 object-cover rounded-md">
